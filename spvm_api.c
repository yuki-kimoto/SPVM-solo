...
void SPVM_API_call_sub(SPVM* spvm, SPVM_ENV* env, const char* sub_abs_name) {
  ...
  // while (1) {
    // switch (*pc) {
      ...
      case_SPVM_BYTECODE_C_CODE_PUSH_SHORT:
        operand_stack_top++;
        call_stack[operand_stack_top].short_value = (int16_t)((int16_t)(*(pc + 1) << 8) +  *(pc + 2));
        pc += 3;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_PUSH_BYTE_TO_INT:
        operand_stack_top++;
        call_stack[operand_stack_top].int_value = (int8_t)*(pc + 1);
        pc += 2;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_PUSH_SHORT_TO_LONG:
        operand_stack_top++;
        *(int64_t*)&call_stack[operand_stack_top] = (int64_t)((*(pc + 1) << 8) +  *(pc + 2));
        pc += 3;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_PUSH_BYTE_TO_LONG:
        operand_stack_top++;
        *(int64_t*)&call_stack[operand_stack_top] = (int64_t)*(pc + 1);
        pc += 2;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_PUSH_SHORT_TO_INT:
        operand_stack_top++;
        call_stack[operand_stack_top].int_value = (int16_t)((int16_t)(*(pc + 1) << 8) +  *(pc + 2));
        pc += 3;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_LOAD_CONSTANT:
        operand_stack_top++;
        *(int64_t*)&call_stack[operand_stack_top] = *(int64_t*)&constant_pool[(*(pc + 1) << 24) + (*(pc + 2) << 16) + (*(pc + 3) << 8) + *(pc + 4)];
        pc += 5;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_LOAD:
        operand_stack_top++;
      ...
      case_SPVM_BYTECODE_C_CODE_ARRAY_LOAD_BYTE:
        call_stack[operand_stack_top - 1].byte_value
          = *(int8_t*)(*(intptr_t*)&call_stack[operand_stack_top - 1] + sizeof(SPVM_DATA_OBJECT_HEADER) + sizeof(int8_t) * (size_t)*(int64_t*)&call_stack[operand_stack_top]);
        operand_stack_top--;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_ARRAY_LOAD_SHORT:
        *(int16_t*)&call_stack[operand_stack_top - 1]
          = *(int16_t*)(*(intptr_t*)&call_stack[operand_stack_top - 1] + sizeof(SPVM_DATA_OBJECT_HEADER) + sizeof(int16_t) * (size_t)*(int64_t*)&call_stack[operand_stack_top]);
        operand_stack_top--;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_ARRAY_LOAD_INT:
        *(int32_t*)&call_stack[operand_stack_top - 1]
          = *(int32_t*)(*(intptr_t*)&call_stack[operand_stack_top - 1] + sizeof(SPVM_DATA_OBJECT_HEADER) + sizeof(int32_t) * (size_t)*(int64_t*)&call_stack[operand_stack_top]);
        operand_stack_top--;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_ARRAY_LOAD_LONG: {
        *(int64_t*)&call_stack[operand_stack_top - 1]
          = *(int64_t*)(*(intptr_t*)&call_stack[operand_stack_top - 1] + sizeof(SPVM_DATA_OBJECT_HEADER) + sizeof(int64_t) * (size_t)*(int64_t*)&call_stack[operand_stack_top]);
        operand_stack_top--;
        pc++;
        goto *jump[*pc];
      }
      case_SPVM_BYTECODE_C_CODE_ARRAY_LOAD_FLOAT:
        *(float*)&call_stack[operand_stack_top - 1].float_value
          = *(float*)(*(intptr_t*)&call_stack[operand_stack_top - 1] + sizeof(SPVM_DATA_OBJECT_HEADER) + sizeof(float) * (size_t)*(int64_t*)&call_stack[operand_stack_top]);
        operand_stack_top--;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_ARRAY_LOAD_DOUBLE:
        *(double*)&call_stack[operand_stack_top - 1]
          = *(double*)(*(intptr_t*)&call_stack[operand_stack_top - 1] + sizeof(SPVM_DATA_OBJECT_HEADER) + sizeof(double) * (size_t)*(int64_t*)&call_stack[operand_stack_top]);
        operand_stack_top--;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_ARRAY_LOAD_ADDRESS:
        call_stack[operand_stack_top - 1].address_value
          = *(void**)(*(intptr_t*)&call_stack[operand_stack_top - 1] + sizeof(SPVM_DATA_OBJECT_HEADER) + sizeof(void*) * (size_t)*(int64_t*)&call_stack[operand_stack_top]);
        operand_stack_top--;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_STORE:
      ...
      case_SPVM_BYTECODE_C_CODE_ARRAY_STORE_BYTE:
        *(int8_t*)(*(intptr_t*)&call_stack[operand_stack_top - 2] + sizeof(SPVM_DATA_OBJECT_HEADER) + sizeof(int8_t) * (size_t)*(int64_t*)&call_stack[operand_stack_top - 1])
          = call_stack[operand_stack_top].byte_value;
        operand_stack_top -= 3;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_ARRAY_STORE_SHORT:
        *(int16_t*)(*(intptr_t*)&call_stack[operand_stack_top - 2] + sizeof(SPVM_DATA_OBJECT_HEADER) + sizeof(int16_t) * (size_t)*(int64_t*)&call_stack[operand_stack_top - 1])
          = call_stack[operand_stack_top].short_value;
        operand_stack_top -= 3;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_ARRAY_STORE_INT:
        *(int32_t*)(*(intptr_t*)&call_stack[operand_stack_top - 2] + sizeof(SPVM_DATA_OBJECT_HEADER) + sizeof(int32_t) * (size_t)*(int64_t*)&call_stack[operand_stack_top - 1])
          = call_stack[operand_stack_top].int_value;
        operand_stack_top -= 3;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_ARRAY_STORE_LONG:
        *(int64_t*)(*(intptr_t*)&call_stack[operand_stack_top - 2] + sizeof(SPVM_DATA_OBJECT_HEADER) + sizeof(int64_t) * (size_t)*(int64_t*)&call_stack[operand_stack_top - 1])
          = *(int64_t*)&call_stack[operand_stack_top];
        operand_stack_top -= 3;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_ARRAY_STORE_FLOAT:
        *(float*)(*(intptr_t*)&call_stack[operand_stack_top - 2] + sizeof(SPVM_DATA_OBJECT_HEADER) + sizeof(float) * (size_t)*(int64_t*)&call_stack[operand_stack_top - 1])
          = call_stack[operand_stack_top - 1].float_value;
        operand_stack_top -= 3;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_ARRAY_STORE_DOUBLE:
        *(double*)(*(intptr_t*)&call_stack[operand_stack_top - 2] + sizeof(SPVM_DATA_OBJECT_HEADER) + sizeof(double) * (size_t)*(int64_t*)&call_stack[operand_stack_top - 1])
          = *(double*)&call_stack[operand_stack_top];
        operand_stack_top -= 3;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_ARRAY_STORE_ADDRESS: {
        intptr_t array_index = *(intptr_t*)&call_stack[operand_stack_top - 2] + sizeof(SPVM_DATA_OBJECT_HEADER) + sizeof(void*) * (size_t)*(int64_t*)&call_stack[operand_stack_top - 1];
        ...
        // Store address
        *(void**)(array_index) = call_stack[operand_stack_top].address_value;
      ...
      case_SPVM_BYTECODE_C_CODE_ADD_BYTE:
        ...
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_ADD_SHORT:
        *(int16_t*)&call_stack[operand_stack_top - 1] += call_stack[operand_stack_top].short_value;
        operand_stack_top--;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_ADD_INT:
        *(int32_t*)&call_stack[operand_stack_top - 1] += call_stack[operand_stack_top].int_value;
        operand_stack_top--;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_ADD_LONG:
        *(int64_t*)&call_stack[operand_stack_top - 1] += *(int64_t*)&call_stack[operand_stack_top];
        ...
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_ADD_FLOAT:
        *((float*)&call_stack[operand_stack_top -1]) += call_stack[operand_stack_top - 1].float_value;
        operand_stack_top--;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_ADD_DOUBLE:
      ...
      case_SPVM_BYTECODE_C_CODE_MULTIPLY_LONG:
        *(int64_t*)&call_stack[operand_stack_top - 1] *= *(int64_t*)&call_stack[operand_stack_top];
        ...
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_MULTIPLY_FLOAT:
        *(float*)&call_stack[operand_stack_top - 1].float_value *= call_stack[operand_stack_top - 1].float_value;
        operand_stack_top--;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_MULTIPLY_DOUBLE:
      ...
      case_SPVM_BYTECODE_C_CODE_REMAINDER_BYTE:
        ...
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_REMAINDER_SHORT:
        *(int16_t*)&call_stack[operand_stack_top - 1] = *(int16_t*)&call_stack[operand_stack_top - 1] % call_stack[operand_stack_top].short_value;
        operand_stack_top--;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_REMAINDER_INT:
        *(int32_t*)&call_stack[operand_stack_top - 1] = *(int32_t*)&call_stack[operand_stack_top - 1] % call_stack[operand_stack_top].int_value;
        operand_stack_top--;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_REMAINDER_LONG:
      ...
      case_SPVM_BYTECODE_C_CODE_NEGATE_DOUBLE:
        *((double*)&call_stack[operand_stack_top]) = -*((double*)&call_stack[operand_stack_top]);
        ...
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_LEFT_SHIFT_BYTE:
        call_stack[operand_stack_top - 1].byte_value <<= *(int64_t*)&call_stack[operand_stack_top];
        operand_stack_top--;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_LEFT_SHIFT_SHORT:
        *(int16_t*)&call_stack[operand_stack_top - 1] <<= *(int64_t*)&call_stack[operand_stack_top];
        operand_stack_top--;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_LEFT_SHIFT_INT:
        *(int32_t*)&call_stack[operand_stack_top - 1] <<= *(int64_t*)&call_stack[operand_stack_top];
        operand_stack_top--;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_LEFT_SHIFT_LONG:
      ...
      case_SPVM_BYTECODE_C_CODE_RIGHT_SHIFT_LONG:
        *(int64_t*)&call_stack[operand_stack_top - 1] >>= *(int64_t*)&call_stack[operand_stack_top];
        ...
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_RIGHT_SHIFT_UNSIGNED_BYTE:
        call_stack[operand_stack_top - 1].byte_value = (call_stack[operand_stack_top - 1].byte_value >> *(int64_t*)&call_stack[operand_stack_top]) & 0xFF;
        operand_stack_top--;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_RIGHT_SHIFT_UNSIGNED_SHORT:
        call_stack[operand_stack_top - 1].byte_value = (*(int16_t*)&call_stack[operand_stack_top - 1] >> *(int64_t*)&call_stack[operand_stack_top]) & 0xFFFF;
        operand_stack_top--;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_RIGHT_SHIFT_UNSIGNED_INT:
        *(int32_t*)&call_stack[operand_stack_top - 1] = (*(int32_t*)&call_stack[operand_stack_top - 1] >> *(int64_t*)&call_stack[operand_stack_top]) & 0xFFFFFFFF;
        operand_stack_top--;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_RIGHT_SHIFT_UNSIGNED_LONG:
      ...
      case_SPVM_BYTECODE_C_CODE_INC_LONG:
        *(int64_t*)&vars[*(pc + 1)] += (int64_t)*(pc + 2);
        ...
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_CONVERT_INT_TO_LONG:
        *(int64_t*)&call_stack[operand_stack_top] = (int64_t)call_stack[operand_stack_top].int_value;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_CONVERT_INT_TO_FLOAT:
        *((float*)&call_stack[operand_stack_top]) = (float)call_stack[operand_stack_top].int_value;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_CONVERT_INT_TO_DOUBLE:
        *((double*)&call_stack[operand_stack_top]) = (double)call_stack[operand_stack_top].int_value;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_CONVERT_LONG_TO_INT:
        call_stack[operand_stack_top].int_value = (int32_t)*(int64_t*)&call_stack[operand_stack_top];
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_CONVERT_LONG_TO_FLOAT:
      ...
      case_SPVM_BYTECODE_C_CODE_CONVERT_LONG_TO_DOUBLE:
        *((double*)&call_stack[operand_stack_top]) = (double)*((int64_t*)&call_stack[operand_stack_top]);
        ...
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_CONVERT_FLOAT_TO_INT:
        call_stack[operand_stack_top].int_value = (int32_t)*((float*)&call_stack[operand_stack_top]);
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_CONVERT_FLOAT_TO_LONG:
      ...
      case_SPVM_BYTECODE_C_CODE_CONVERT_FLOAT_TO_DOUBLE:
        *((double*)&call_stack[operand_stack_top]) = (double)*((float*)&call_stack[operand_stack_top]);
        ...
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_CONVERT_DOUBLE_TO_INT:
        call_stack[operand_stack_top].int_value = (int32_t)*((double*)&call_stack[operand_stack_top]);
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_CONVERT_DOUBLE_TO_LONG:
      ...
      case_SPVM_BYTECODE_C_CODE_CONVERT_SHORT_TO_INT:
        ...
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_CONVERT_BYTE_TO_LONG:
        *(int64_t*)&call_stack[operand_stack_top] = (int64_t)call_stack[operand_stack_top].byte_value;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_CONVERT_BYTE_TO_FLOAT:
        ...
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_CONVERT_BYTE_TO_DOUBLE:
        *(double*)&call_stack[operand_stack_top] = (double)call_stack[operand_stack_top].byte_value;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_CONVERT_SHORT_TO_BYTE:
        ...
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_CONVERT_SHORT_TO_LONG:
        *(int64_t*)&call_stack[operand_stack_top] = (int64_t)call_stack[operand_stack_top].short_value;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_CONVERT_SHORT_TO_FLOAT:
        ...
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_CONVERT_SHORT_TO_DOUBLE:
        *(double*)&call_stack[operand_stack_top] = (double)call_stack[operand_stack_top].short_value;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_CONVERT_LONG_TO_BYTE:
        call_stack[operand_stack_top].byte_value = (int8_t)*(int64_t*)&call_stack[operand_stack_top];
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_CONVERT_LONG_TO_SHORT:
        call_stack[operand_stack_top].short_value = (int16_t)*(int64_t*)&call_stack[operand_stack_top];
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_CONVERT_FLOAT_TO_BYTE:
        // TODO
      ...
      case_SPVM_BYTECODE_C_CODE_CONVERT_DOUBLE_TO_BYTE:
        // TODO
        call_stack[operand_stack_top].byte_value = (int8_t)*(double*)&call_stack[operand_stack_top];
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_CONVERT_DOUBLE_TO_SHORT:
        // TODO
        call_stack[operand_stack_top].byte_value = (int16_t)*(double*)&call_stack[operand_stack_top];
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_CONVERT_BYTE_TO_SHORT:
      ...
      case_SPVM_BYTECODE_C_CODE_CMP_SHORT:
        ...
        *(int32_t*)&call_stack[operand_stack_top - 1]
          = (*(int16_t*)&call_stack[operand_stack_top - 1] > call_stack[operand_stack_top].short_value)
          + (*(int16_t*)&call_stack[operand_stack_top - 1] < call_stack[operand_stack_top].short_value) * -1;
        operand_stack_top--;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_CMP_FLOAT_L:
        *(int32_t*)&call_stack[operand_stack_top - 1]
          = (*(float*)&call_stack[operand_stack_top - 1].float_value > call_stack[operand_stack_top - 1].float_value)
          + (*(float*)&call_stack[operand_stack_top - 1].float_value < call_stack[operand_stack_top - 1].float_value) * -1
          + -!!(
            isnan(*(float*)&call_stack[operand_stack_top - 1].float_value)
      ...
      case_SPVM_BYTECODE_C_CODE_IF_LE_ZERO_INT:
        ...
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_IF_EQ_CMP_INT:
        success = *(int32_t*)&call_stack[operand_stack_top - 1] == call_stack[operand_stack_top].int_value;
        pc += success * (int16_t)((*(pc + 1) << 8) +  *(pc + 2)) + (~success & 1) * 3;
        operand_stack_top -= 2;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_IF_NE_CMP_INT:
      ...
      case_SPVM_BYTECODE_C_CODE_MALLOC_ARRAY_STRING: {
        ...
        // Set array length
        *(int64_t*)&((SPVM_DATA_OBJECT_HEADER*)address)->array_length_or_sv = length;
      ...
      case_SPVM_BYTECODE_C_CODE_ARRAY_LENGTH:
        *(int64_t*)&call_stack[operand_stack_top] = *(int64_t*)&((SPVM_DATA_OBJECT_HEADER*)call_stack[operand_stack_top].address_value)->array_length_or_sv;
        pc++;
        goto *jump[*pc];
      case_SPVM_BYTECODE_C_CODE_WIDE:
      ...
      case_SPVM_BYTECODE_C_CODE_GET_FIELD_BYTE: {
        ...
        call_stack[operand_stack_top].byte_value = *(int8_t*)(call_stack[operand_stack_top].address_value + sizeof(SPVM_DATA_OBJECT_HEADER) + constant_pool_field->package_byte_offset);
        pc += 5;
        goto *jump[*pc];
      }
      case_SPVM_BYTECODE_C_CODE_GET_FIELD_SHORT: {
        int32_t field_constant_pool_address
          = (*(pc + 1) << 24) + (*(pc + 2) << 16) + (*(pc + 3) << 8) + *(pc + 4);
        SPVM_CONSTANT_POOL_FIELD* constant_pool_field = (SPVM_CONSTANT_POOL_FIELD*)&constant_pool[field_constant_pool_address];
        call_stack[operand_stack_top].short_value = *(int16_t*)(call_stack[operand_stack_top].address_value + sizeof(SPVM_DATA_OBJECT_HEADER) + constant_pool_field->package_byte_offset);
        pc += 5;
        goto *jump[*pc];
      }
      case_SPVM_BYTECODE_C_CODE_GET_FIELD_INT: {
        int32_t field_constant_pool_address
          = (*(pc + 1) << 24) + (*(pc + 2) << 16) + (*(pc + 3) << 8) + *(pc + 4);
        SPVM_CONSTANT_POOL_FIELD* constant_pool_field = (SPVM_CONSTANT_POOL_FIELD*)&constant_pool[field_constant_pool_address];
        call_stack[operand_stack_top].int_value = *(int32_t*)(call_stack[operand_stack_top].address_value + sizeof(SPVM_DATA_OBJECT_HEADER) + constant_pool_field->package_byte_offset);
        pc += 5;
        goto *jump[*pc];
      }
      case_SPVM_BYTECODE_C_CODE_GET_FIELD_LONG: {
        int32_t field_constant_pool_address
          = (*(pc + 1) << 24) + (*(pc + 2) << 16) + (*(pc + 3) << 8) + *(pc + 4);
        SPVM_CONSTANT_POOL_FIELD* constant_pool_field = (SPVM_CONSTANT_POOL_FIELD*)&constant_pool[field_constant_pool_address];
        *(int64_t*)&call_stack[operand_stack_top] = *(int64_t*)(call_stack[operand_stack_top].address_value + sizeof(SPVM_DATA_OBJECT_HEADER) + constant_pool_field->package_byte_offset);
        pc += 5;
        goto *jump[*pc];
      }
      case_SPVM_BYTECODE_C_CODE_GET_FIELD_FLOAT: {
        int32_t field_constant_pool_address
          = (*(pc + 1) << 24) + (*(pc + 2) << 16) + (*(pc + 3) << 8) + *(pc + 4);
        SPVM_CONSTANT_POOL_FIELD* constant_pool_field = (SPVM_CONSTANT_POOL_FIELD*)&constant_pool[field_constant_pool_address];
        call_stack[operand_stack_top - 1].float_value = *(float*)(call_stack[operand_stack_top].address_value + sizeof(SPVM_DATA_OBJECT_HEADER) + constant_pool_field->package_byte_offset);
        pc += 5;
        goto *jump[*pc];
      }
      case_SPVM_BYTECODE_C_CODE_GET_FIELD_DOUBLE: {
        int32_t field_constant_pool_address
          = (*(pc + 1) << 24) + (*(pc + 2) << 16) + (*(pc + 3) << 8) + *(pc + 4);
        SPVM_CONSTANT_POOL_FIELD* constant_pool_field = (SPVM_CONSTANT_POOL_FIELD*)&constant_pool[field_constant_pool_address];
        *(double*)&call_stack[operand_stack_top] = *(double*)(call_stack[operand_stack_top].address_value + sizeof(SPVM_DATA_OBJECT_HEADER) + constant_pool_field->package_byte_offset);
        pc += 5;
        goto *jump[*pc];
      }
      case_SPVM_BYTECODE_C_CODE_GET_FIELD_ADDRESS: {
        int32_t field_constant_pool_address
          = (*(pc + 1) << 24) + (*(pc + 2) << 16) + (*(pc + 3) << 8) + *(pc + 4);
        SPVM_CONSTANT_POOL_FIELD* constant_pool_field = (SPVM_CONSTANT_POOL_FIELD*)&constant_pool[field_constant_pool_address];
        call_stack[operand_stack_top].address_value = *(void**)(call_stack[operand_stack_top].address_value + sizeof(SPVM_DATA_OBJECT_HEADER) + constant_pool_field->package_byte_offset);
        pc += 5;
        goto *jump[*pc];
      }
      case_SPVM_BYTECODE_C_CODE_SET_FIELD_BYTE: {
        int32_t field_constant_pool_address
          = (*(pc + 1) << 24) + (*(pc + 2) << 16) + (*(pc + 3) << 8) + *(pc + 4);
        SPVM_CONSTANT_POOL_FIELD* constant_pool_field = (SPVM_CONSTANT_POOL_FIELD*)&constant_pool[field_constant_pool_address];
        *(int8_t*)(call_stack[operand_stack_top - 1].address_value + constant_pool_field->package_byte_offset) = call_stack[operand_stack_top].byte_value;
        operand_stack_top -= 2;
        pc += 5;
        goto *jump[*pc];
      }
      case_SPVM_BYTECODE_C_CODE_SET_FIELD_SHORT: {
        int32_t field_constant_pool_address
          = (*(pc + 1) << 24) + (*(pc + 2) << 16) + (*(pc + 3) << 8) + *(pc + 4);
        SPVM_CONSTANT_POOL_FIELD* constant_pool_field = (SPVM_CONSTANT_POOL_FIELD*)&constant_pool[field_constant_pool_address];
        *(int16_t*)(call_stack[operand_stack_top - 1].address_value + sizeof(SPVM_DATA_OBJECT_HEADER) + constant_pool_field->package_byte_offset) = call_stack[operand_stack_top].short_value;
        operand_stack_top -= 2;
        pc += 5;
        goto *jump[*pc];
      }
      case_SPVM_BYTECODE_C_CODE_SET_FIELD_INT: {
        int32_t field_constant_pool_address
          = (*(pc + 1) << 24) + (*(pc + 2) << 16) + (*(pc + 3) << 8) + *(pc + 4);
        SPVM_CONSTANT_POOL_FIELD* constant_pool_field = (SPVM_CONSTANT_POOL_FIELD*)&constant_pool[field_constant_pool_address];
        *(int32_t*)(call_stack[operand_stack_top - 1].address_value + sizeof(SPVM_DATA_OBJECT_HEADER) + constant_pool_field->package_byte_offset) = call_stack[operand_stack_top].int_value;
        operand_stack_top -= 2;
        pc += 5;
        goto *jump[*pc];
      }
      case_SPVM_BYTECODE_C_CODE_SET_FIELD_LONG: {
        int32_t field_constant_pool_address
          = (*(pc + 1) << 24) + (*(pc + 2) << 16) + (*(pc + 3) << 8) + *(pc + 4);
        SPVM_CONSTANT_POOL_FIELD* constant_pool_field = (SPVM_CONSTANT_POOL_FIELD*)&constant_pool[field_constant_pool_address];
        *(int64_t*)(call_stack[operand_stack_top - 1].address_value + sizeof(SPVM_DATA_OBJECT_HEADER) + constant_pool_field->package_byte_offset) = *(int64_t*)&call_stack[operand_stack_top];
        operand_stack_top -= 2;
        pc += 5;
        goto *jump[*pc];
      }
      case_SPVM_BYTECODE_C_CODE_SET_FIELD_FLOAT: {
        int32_t field_constant_pool_address
          = (*(pc + 1) << 24) + (*(pc + 2) << 16) + (*(pc + 3) << 8) + *(pc + 4);
        SPVM_CONSTANT_POOL_FIELD* constant_pool_field = (SPVM_CONSTANT_POOL_FIELD*)&constant_pool[field_constant_pool_address];
        *(float*)(call_stack[operand_stack_top - 1].address_value + sizeof(SPVM_DATA_OBJECT_HEADER) + constant_pool_field->package_byte_offset) = call_stack[operand_stack_top - 1].float_value;
        operand_stack_top -= 2;
        pc += 5;
        goto *jump[*pc];
      }
      case_SPVM_BYTECODE_C_CODE_SET_FIELD_DOUBLE: {
        int32_t field_constant_pool_address
          = (*(pc + 1) << 24) + (*(pc + 2) << 16) + (*(pc + 3) << 8) + *(pc + 4);
        SPVM_CONSTANT_POOL_FIELD* constant_pool_field = (SPVM_CONSTANT_POOL_FIELD*)&constant_pool[field_constant_pool_address];
        *(double*)(call_stack[operand_stack_top - 1].address_value + sizeof(SPVM_DATA_OBJECT_HEADER) + constant_pool_field->package_byte_offset) = *(double*)&call_stack[operand_stack_top];
        operand_stack_top -= 2;
        pc += 5;
        goto *jump[*pc];
      }
      case_SPVM_BYTECODE_C_CODE_SET_FIELD_ADDRESS: {
        ...
        intptr_t field_index = (intptr_t)call_stack[operand_stack_top - 1].address_value + constant_pool_field->package_byte_offset;
        ...
        // Store object
        *(void**)(field_index) = call_stack[operand_stack_top].address_value;
  ...
  if (address != NULL) {
    ...
    if (((SPVM_DATA_OBJECT_HEADER*)address)->ref_count == 0) {
      ...
      if (((SPVM_DATA_OBJECT_HEADER*)address)->type == SPVM_DATA_OBJECT_HEADER_C_TYPE_STRING) {
        ...
        SPVM_SV* sv = (SPVM_SV*)*(void**)&((SPVM_DATA_OBJECT_HEADER*)address)->array_length_or_sv;
      ...
      // Object is array of string
        ...
        // Array length
        int64_t length = *(int64_t*)&((SPVM_DATA_OBJECT_HEADER*)address)->array_length_or_sv;
...
int64_t SPVM_API_get_array_length(SPVM* spvm, SPVM_ENV* env, void* address) {
  ...
  return *(int64_t*)&((SPVM_DATA_OBJECT_HEADER*)address)->array_length_or_sv;
}
...
SPVM_SV* SPVM_API_get_string_sv(SPVM* spvm, SPVM_ENV* env, void* address) {
  ...
  return (SPVM_SV*)*(void**)&((SPVM_DATA_OBJECT_HEADER*)address)->array_length_or_sv;
}
...
void* SPVM_API_create_string_sv(SPVM* spvm, SPVM_ENV* env, SPVM_SV* sv) {
  ...
  // Set sv
  *(void**)&((SPVM_DATA_OBJECT_HEADER*)address)->array_length_or_sv = sv;
