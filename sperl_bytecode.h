...
enum {
  ...
  SPerl_BYTECODE_C_CODE_BCONST_0,
  SPerl_BYTECODE_C_CODE_BCONST_1,
  SPerl_BYTECODE_C_CODE_SCONST_0,
  SPerl_BYTECODE_C_CODE_SCONST_1,
  ...
  SPerl_BYTECODE_C_CODE_BBPUSH,
  SPerl_BYTECODE_C_CODE_BSPUSH,
  SPerl_BYTECODE_C_CODE_SSPUSH,
  SPerl_BYTECODE_C_CODE_BIPUSH,
  SPerl_BYTECODE_C_CODE_SIPUSH,
  SPerl_BYTECODE_C_CODE_BLPUSH,
  SPerl_BYTECODE_C_CODE_SLPUSH,
  SPerl_BYTECODE_C_CODE_LDC,
  SPerl_BYTECODE_C_CODE_LDC_W,
  SPerl_BYTECODE_C_CODE_IALOAD_LIDX,
  SPerl_BYTECODE_C_CODE_LALOAD_LIDX,
  SPerl_BYTECODE_C_CODE_FALOAD_LIDX,
  SPerl_BYTECODE_C_CODE_DALOAD_LIDX,
  SPerl_BYTECODE_C_CODE_BALOAD_LIDX,
  SPerl_BYTECODE_C_CODE_SALOAD_LIDX,
  SPerl_BYTECODE_C_CODE_BASTORE_LIDX,
  SPerl_BYTECODE_C_CODE_SASTORE_LIDX,
  SPerl_BYTECODE_C_CODE_IASTORE_LIDX,
  SPerl_BYTECODE_C_CODE_LASTORE_LIDX,
  SPerl_BYTECODE_C_CODE_FASTORE_LIDX,
  SPerl_BYTECODE_C_CODE_DASTORE_LIDX,
  ...
  SPerl_BYTECODE_C_CODE_IF_LCMPEQ,
  SPerl_BYTECODE_C_CODE_IF_LCMPNE,
  SPerl_BYTECODE_C_CODE_IF_LCMPLT,
  SPerl_BYTECODE_C_CODE_IF_LCMPGE,
  SPerl_BYTECODE_C_CODE_IF_LCMPGT,
  SPerl_BYTECODE_C_CODE_IF_LCMPLE,
  ...
  SPerl_BYTECODE_C_CODE_BADD,
  SPerl_BYTECODE_C_CODE_BSUB,
  SPerl_BYTECODE_C_CODE_BMUL,
  SPerl_BYTECODE_C_CODE_BDIV,
  SPerl_BYTECODE_C_CODE_BREM,
  SPerl_BYTECODE_C_CODE_BNEG,
  SPerl_BYTECODE_C_CODE_BSHL,
  SPerl_BYTECODE_C_CODE_BSHR,
  SPerl_BYTECODE_C_CODE_BUSHR,
  SPerl_BYTECODE_C_CODE_BAND,
  SPerl_BYTECODE_C_CODE_BOR ,
  SPerl_BYTECODE_C_CODE_BXOR,
  SPerl_BYTECODE_C_CODE_BCMP,
  SPerl_BYTECODE_C_CODE_SADD,
  SPerl_BYTECODE_C_CODE_SSUB,
  SPerl_BYTECODE_C_CODE_SMUL,
  SPerl_BYTECODE_C_CODE_SDIV,
  SPerl_BYTECODE_C_CODE_SREM,
  SPerl_BYTECODE_C_CODE_SNEG,
  SPerl_BYTECODE_C_CODE_SSHL,
  SPerl_BYTECODE_C_CODE_SSHR,
  SPerl_BYTECODE_C_CODE_SUSHR,
  SPerl_BYTECODE_C_CODE_SAND,
  SPerl_BYTECODE_C_CODE_SOR ,
  SPerl_BYTECODE_C_CODE_SXOR,
  SPerl_BYTECODE_C_CODE_SCMP,
  SPerl_BYTECODE_C_CODE_MALLOCSTRING,
  SPerl_BYTECODE_C_CODE_BINC,
  SPerl_BYTECODE_C_CODE_SINC,
};
