...
enum {
  ...
  SPerl_BYTECODE_C_CODE_MALLOC_OBJECT,
  SPerl_BYTECODE_C_CODE_MALLOC_ARRAY,
  SPerl_BYTECODE_C_CODE_MALLOC_STRING,
  ...
  SPerl_BYTECODE_C_CODE_INCREFCOUNT,
  SPerl_BYTECODE_C_CODE_DECREFCOUNT,
};
