...
enum {
  ...
  SPerl_VMCODE_C_CODE_ISUBTRACT,
  SPerl_VMCODE_C_CODE_LSUBTRACT,
  SPerl_VMCODE_C_CODE_FSUBTRACT,
  SPerl_VMCODE_C_CODE_DSUBTRACT,
  SPerl_VMCODE_C_CODE_IMULTIPLY,
  SPerl_VMCODE_C_CODE_LMULTIPLY,
  SPerl_VMCODE_C_CODE_FMULTIPLY,
  SPerl_VMCODE_C_CODE_DMULTIPLY,
  SPerl_VMCODE_C_CODE_IDIVIDE,
  SPerl_VMCODE_C_CODE_LDIVIDE,
  SPerl_VMCODE_C_CODE_FDIVIDE,
  SPerl_VMCODE_C_CODE_DDIVIDE,
  ...
  SPerl_VMCODE_C_CODE_INEGATE,
  SPerl_VMCODE_C_CODE_LNEGATE,
  SPerl_VMCODE_C_CODE_FNEGATE,
  SPerl_VMCODE_C_CODE_DNEGATE,
  SPerl_VMCODE_C_CODE_IREMAINDER,
  SPerl_VMCODE_C_CODE_LREMAINDER,
  SPerl_VMCODE_C_CODE_FREMAINDER,
  SPerl_VMCODE_C_CODE_DREMAINDER,
