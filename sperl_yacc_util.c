...
void SPerl_yyerror_format(SPerl* sperl, const char* message_template, ...) {
  ...
  char* message_template_with_prefix = SPerl_ALLOCATOR_PARSER_alloc_string(sperl, sperl->parser->allocator, message_template_with_prefix_length);
  ...
  char* message = SPerl_ALLOCATOR_PARSER_alloc_string(sperl, sperl->parser->allocator, message_length);
