...
void SPerl_BYTECODE_BUILDER_push_inc_bytecode(SPerl* sperl, SPerl_BYTECODE_ARRAY* bytecode_array, SPerl_OP* op_inc, int32_t value) {
  ...
  if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_BYTE) {
    if (my_var->address > 0xFF || (value < -128 || value > 127)) {
      ...
      SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_BINC);
    ...
    if (my_var->address > 0xFF || (value < -128 || value > 127)) {
      SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_WIDE);
      SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_SINC);
      SPerl_BYTECODE_ARRAY_push(bytecode_array, (my_var->address >> 8) & 0xFF);
      SPerl_BYTECODE_ARRAY_push(bytecode_array, my_var->address & 0xFF);
      SPerl_BYTECODE_ARRAY_push(bytecode_array, (value >> 8) & 0xFF);
      SPerl_BYTECODE_ARRAY_push(bytecode_array, value & 0xFF);
...
void SPerl_BYTECODE_BUILDER_push_load_bytecode(SPerl* sperl, SPerl_BYTECODE_ARRAY* bytecode_array, SPerl_OP* op_var) {
  ...
  _Bool has_operand = 0;
  if (my_var_pos == 0) {
    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_LOAD_0);
  }
  else if (my_var_pos == 1) {
    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_LOAD_1);
  }
  else if (my_var_pos == 2) {
    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_LOAD_2);
  }
  else if (my_var_pos == 3) {
    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_LOAD_3);
  }
  else {
    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_LOAD);
    has_operand = 1;
  }
          ...
          case SPerl_OP_C_CODE_BLOCK: {
            if (op_cur->flag & SPerl_OP_C_FLAG_BLOCK_LOOP) {
              ...
              *pos_ptr = bytecode_array->length - 1;
              SPerl_ARRAY_push(sperl, goto_loop_start_address_stack, pos_ptr);
            ...
            switch (op_cur->code) {
              ...
              case SPerl_OP_C_CODE_SWITCH: {
                ...
                // lookupswitch
                  ...
                  *(int64_t*)&bytecode_array->values[cur_switch_address + padding + 1] = default_offset;
                  ...
                  for (int64_t i = 0; i < length; i++) {
                    SPerl_OP* case_address = SPerl_ARRAY_fetch(sperl, cur_case_addresses, i);
                    SPerl_ARRAY_push(sperl, ordered_case_addresses, case_address);
                  }
                  ...
                  for (int64_t i = 0; i < length; i++) {
                    for (int64_t j = i + 1; j < length; j++) {
                      ...
                      SPerl_OP* case_address_i = SPerl_ARRAY_fetch(sperl, ordered_case_addresses, i);
                      SPerl_OP* case_address_j = SPerl_ARRAY_fetch(sperl, ordered_case_addresses, j);
              ...
              case SPerl_OP_C_CODE_FIELD: {
                ...
                if (!op_cur->lvalue) {
                  ...
                  SPerl_FIELD* field = SPerl_HASH_search(sperl, parser->field_symtable, field_name, strlen(field_name));
              ...
              case SPerl_OP_C_CODE_CALL_SUB: {
                ...
                if (try_stack->length > 0) {
                  ...
                  int32_t* pos_ptr = SPerl_ALLOCATOR_new_int(sperl);
                  *pos_ptr = bytecode_array->length - 1;
                  SPerl_ARRAY_push(sperl, goto_exception_handler_stack, pos_ptr);
              ...
              case SPerl_OP_C_CODE_LAST: {
                ...
                int32_t* pos_ptr = SPerl_ALLOCATOR_new_int(sperl);
                *pos_ptr = bytecode_array->length - 1;
                SPerl_ARRAY_push(sperl, goto_last_address_stack, pos_ptr);
              ...
              case SPerl_OP_C_CODE_NEXT: {
                int32_t* pos_ptr = SPerl_ARRAY_fetch(sperl, goto_loop_start_address_stack, goto_loop_start_address_stack->length - 1);
              ...
              case SPerl_OP_C_CODE_BLOCK: {
                if (op_cur->flag & SPerl_OP_C_FLAG_BLOCK_IF) {
                  ...
                  if (op_cur->flag & SPerl_OP_C_FLAG_BLOCK_HAS_ELSE) {
                    ...
                    int32_t* pos_ptr = SPerl_ALLOCATOR_new_int(sperl);
                    *pos_ptr = bytecode_array->length - 1;
                    SPerl_ARRAY_push(sperl, goto_if_block_end_address_stack, pos_ptr);
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, 0);
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, 0);
                  }

                  // Set if jump address
                  int32_t* pos_ptr = SPerl_ARRAY_pop(sperl, if_address_stack);
                  ...
                  int32_t* pos_ptr = SPerl_ARRAY_pop(sperl, goto_if_block_end_address_stack);
              ...
              case SPerl_OP_C_CODE_LOOP: {
                ...
                while ((goto_last_address_ptr = SPerl_ARRAY_pop(sperl, goto_last_address_stack))) {
                  // Last offset
              ...
              case SPerl_OP_C_CODE_CONDITION: {
                ...
                if (op_condition_target->code == SPerl_OP_C_CODE_UNDEF) {
                  ...
                  if (!resolved_type) {
                    ...
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_BCMP);
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_IFNE);
                  }
                  else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_SHORT) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_SCMP);
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_IFNE);
                  }
                  else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_INT) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_ICMP);
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_IFNE);
                  }
                  else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_LONG) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_IF_LCMPNE);
                  }
                  else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_FLOAT) {
                  ...
                  if (!resolved_type) {
                    ...
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_IF_LCMPEQ);
                  }
                  else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_FLOAT) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_FCMPG);
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_IFEQ);
                  ...
                  if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_BYTE) {
                    ...
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_IF_LCMPLE);
                  }
                  else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_FLOAT) {
                  ...
                  if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_BYTE) {
                    ...
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_IF_LCMPLT);
                  }
                  else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_FLOAT) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_FCMPL);
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_IFLT);
                  ...
                  if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_BYTE) {
                    ...
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_IF_LCMPGE);
                  }
                  else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_FLOAT) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_FCMPG);
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_IFGE);
                  ...
                  if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_BYTE) {
                    ...
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_IF_LCMPGT);
                  }
                  else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_FLOAT) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_FCMPG);
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_IFGT);
                  ...
                  if (op_condition_target->code == SPerl_OP_C_CODE_IF) {
                    ...
                    if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_BYTE) {
                      SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_B2L);
                      SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_IFNE);
                    }
                    else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_SHORT) {
                      SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_S2L);
                      SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_IFNE);
                    }
                    else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_INT) {
                ...
                *pos_ptr = bytecode_array->length - 1;
                ...
                if (op_cur->flag & SPerl_OP_C_FLAG_CONDITION_IF) {
                  SPerl_ARRAY_push(sperl, if_address_stack, pos_ptr);
              ...
              case SPerl_OP_C_CODE_LEFT_SHIFT: {
                ...
                if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_BYTE) {
                  SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_BSHL);
                }
                else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_SHORT) {
                  SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_SSHL);
                }
                else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_INT) {
              ...
              case SPerl_OP_C_CODE_RIGHT_SHIFT: {
                ...
                if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_BYTE) {
                  SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_BSHR);
                }
                else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_SHORT) {
                  SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_SSHR);
                }
                else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_INT) {
              ...
              case SPerl_OP_C_CODE_RIGHT_SHIFT_UNSIGNED: {
                ...
                if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_BYTE) {
                  SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_BUSHR);
                }
                else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_SHORT) {
                  SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_SUSHR);
                }
                else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_INT) {
              ...
              case SPerl_OP_C_CODE_BIT_XOR: {
                ...
                SPerl_RESOLVED_TYPE* resolved_type = SPerl_OP_get_resolved_type(sperl, op_cur);
                if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_BYTE) {
                  SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_BXOR);
                }
                else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_SHORT) {
                  SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_SXOR);
                }
                else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_INT) {
              ...
              case SPerl_OP_C_CODE_BIT_OR: {
                ...
                SPerl_RESOLVED_TYPE* resolved_type = SPerl_OP_get_resolved_type(sperl, op_cur);
                if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_BYTE) {
                  SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_BOR);
                }
                else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_SHORT) {
                  SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_SOR);
                }
                else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_INT) {
              ...
              case SPerl_OP_C_CODE_BIT_AND: {
                ...
                if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_BYTE) {
                  SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_BAND);
                }
                else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_SHORT) {
                  SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_SAND);
                }
                else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_INT) {
              ...
              case SPerl_OP_C_CODE_ASSIGN: {
                ...
                if (op_cur->first->code == SPerl_OP_C_CODE_VAR) {
                  ...
                  if (my_var_pos == 0) {
                    ...
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_STORE_2);
                  }
                  else if (my_var_pos == 3) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_STORE_3);
                  }
                  else {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_STORE);
                    has_operand = 1;
                  }
                  ...
                  if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_BYTE) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_BPUTFIELD);
                  }
                  else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_SHORT) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_SPUTFIELD);
                  }
                  else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_INT) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_IPUTFIELD);
                  }
                  else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_LONG) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_LPUTFIELD);
                  }
                  else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_FLOAT) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_FPUTFIELD);
                  }
                  else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_DOUBLE) {
              ...
              case SPerl_OP_C_CODE_RETURN: {
                ...
                SPerl_RESOLVED_TYPE* resolved_type = SPerl_OP_get_resolved_type(sperl, op_cur);
                if (!resolved_type) {
                  SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_RETURN_VOID);
                }
                else {
                  SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_RETURN_VALUE);
                }
              ...
              case SPerl_OP_C_CODE_NEGATE: {
                ...
                SPerl_RESOLVED_TYPE* resolved_type = SPerl_OP_get_resolved_type(sperl, op_cur);
                if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_BYTE) {
                  SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_BNEG);
                }
                else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_SHORT) {
                  SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_SNEG);
                }
                else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_INT) {
              ...
              case SPerl_OP_C_CODE_CONVERT: {
                ...
                if (src_resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_BYTE) {
                  if (dist_resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_BYTE) {
                    ...
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_B2S);
                  }
                  else if (dist_resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_INT) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_B2I);
                  }
                  else if (dist_resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_LONG) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_B2L);
                  }
                  else if (dist_resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_FLOAT) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_B2F);
                  }
                  else if (dist_resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_DOUBLE) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_B2D);
                  }
                  else {
                    assert(0);
                  }
                  ...
                  if (dist_resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_BYTE) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_S2B);
                  }
                  else if (dist_resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_SHORT) {
                    // None
                  }
                  else if (dist_resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_INT) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_S2I);
                  }
                  else if (dist_resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_LONG) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_S2L);
                  }
                  else if (dist_resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_FLOAT) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_S2F);
                  }
                  else if (dist_resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_DOUBLE) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_S2D);
                  }
                  else {
                    assert(0);
                  }
                  ...
                  if (dist_resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_BYTE) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_I2B);
                  }
                  else if (dist_resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_SHORT) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_I2S);
                  }
                  else if (dist_resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_INT) {
                    // None
                  }
                  ...
                  if (dist_resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_BYTE) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_L2B);
                  }
                  else if (dist_resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_SHORT) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_L2S);
                  }
                  else if (dist_resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_INT) {
                  ...
                  if (dist_resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_BYTE) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_F2B);
                  }
                  else if (dist_resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_SHORT) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_F2S);
                  }
                  else if (dist_resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_INT) {
                  ...
                  if (dist_resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_BYTE) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_D2B);
                  }
                  else if (dist_resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_SHORT) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_D2S);
                  }
                  else if (dist_resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_INT) {
              ...
              case SPerl_OP_C_CODE_ADD: {
                ...
                SPerl_RESOLVED_TYPE* resolved_type = SPerl_OP_get_resolved_type(sperl, op_cur);
                if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_BYTE) {
                  SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_BADD);
                }
                else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_SHORT) {
                  SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_SADD);
                }
                else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_INT) {
              ...
              case SPerl_OP_C_CODE_SUBTRACT: {
                ...
                SPerl_RESOLVED_TYPE* resolved_type = SPerl_OP_get_resolved_type(sperl, op_cur);
                if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_BYTE) {
                  SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_BSUB);
                }
                else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_SHORT) {
                  SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_SSUB);
                }
                else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_INT) {
              ...
              case SPerl_OP_C_CODE_MULTIPLY: {
                ...
                SPerl_RESOLVED_TYPE* resolved_type = SPerl_OP_get_resolved_type(sperl, op_cur);
                if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_BYTE) {
                  SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_BMUL);
                }
                else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_SHORT) {
                  SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_SMUL);
                }
                else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_INT) {
              ...
              case SPerl_OP_C_CODE_DIVIDE: {
                ...
                SPerl_RESOLVED_TYPE* resolved_type = SPerl_OP_get_resolved_type(sperl, op_cur);
                if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_BYTE) {
                  SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_BDIV);
                }
                else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_SHORT) {
                  SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_SDIV);
                }
                else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_INT) {
              ...
              case SPerl_OP_C_CODE_REMAINDER: {
                ...
                SPerl_RESOLVED_TYPE* resolved_type = SPerl_OP_get_resolved_type(sperl, op_cur);
                if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_BYTE) {
                  SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_BREM);
                }
                else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_SHORT) {
                  SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_SREM);
                }
                else if (resolved_type->id == SPerl_RESOLVED_TYPE_C_ID_INT) {
              ...
              case SPerl_OP_C_CODE_CONSTANT: {
                ...
                if (constant->code == SPerl_CONSTANT_C_CODE_BYTE) {
                  ...
                  if (constant->uv.long_value == -1) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_LCONST_M1);
                    bytecode_set = 1;
                  }
                    ...
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_LCONST_2);
                    bytecode_set = 1;
                  }
                  else if (constant->uv.long_value == 3) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_LCONST_3);
                    bytecode_set = 1;
                  }
                  else if (constant->uv.long_value == 4) {
                    SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_LCONST_4);
                    bytecode_set = 1;
                  }
                  ...
                  SPerl_BYTECODE_ARRAY_push(bytecode_array, SPerl_BYTECODE_C_CODE_MALLOCSTRING);
