...
void SPVM_DUMPER_dump_bytecode_array(SPVM* spvm, SPVM_BYTECODE_ARRAY* bytecode_array, int32_t start_pos, int32_t length) {
  ...
  for (int32_t i = start_pos; i <= end_pos; i++) {
    ...
    switch (bytecode) {
      ...
      case SPVM_BYTECODE_C_CODE_PUT_FIELD_BYTE:
      case SPVM_BYTECODE_C_CODE_PUT_FIELD_SHORT:
      case SPVM_BYTECODE_C_CODE_PUT_FIELD_INT:
      case SPVM_BYTECODE_C_CODE_PUT_FIELD_LONG:
      case SPVM_BYTECODE_C_CODE_PUT_FIELD_FLOAT:
      case SPVM_BYTECODE_C_CODE_PUT_FIELD_DOUBLE:
