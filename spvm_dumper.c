...
void SPVM_DUMPER_dump_bytecode_array(SPVM* spvm, SPVM_BYTECODE_ARRAY* bytecode_array, int32_t start_pos, int32_t length) {
  ...
  for (int32_t i = start_pos; i <= end_pos; i++) {
    ...
    switch (bytecode) {
      ...
      // Have one operand
      case SPVM_BYTECODE_C_CODE_BBPUSH:
      case SPVM_BYTECODE_C_CODE_BSPUSH:
      case SPVM_BYTECODE_C_CODE_BIPUSH:
      case SPVM_BYTECODE_C_CODE_BLPUSH:
      case SPVM_BYTECODE_C_CODE_STORE:
      case SPVM_BYTECODE_C_CODE_ASTORE:
      case SPVM_BYTECODE_C_CODE_LOAD:
      case SPVM_BYTECODE_C_CODE_LDC:
      ...
      case SPVM_BYTECODE_C_CODE_LDC_W:
      ...
      // Have four operands
      case SPVM_BYTECODE_C_CODE_BGETFIELD:
      case SPVM_BYTECODE_C_CODE_SGETFIELD:
      case SPVM_BYTECODE_C_CODE_IGETFIELD:
      case SPVM_BYTECODE_C_CODE_LGETFIELD:
      case SPVM_BYTECODE_C_CODE_FGETFIELD:
      case SPVM_BYTECODE_C_CODE_DGETFIELD:
      case SPVM_BYTECODE_C_CODE_BPUTFIELD:
      case SPVM_BYTECODE_C_CODE_SPUTFIELD:
      case SPVM_BYTECODE_C_CODE_IPUTFIELD:
      ...
      case SPVM_BYTECODE_C_CODE_LDC_WW:
