  ...
  while (1) {
    switch (bytecodes[pc]) {
      ...
      case SPerl_BYTECODE_C_CODE_IALOAD:
        *(int32_t*)&call_stack[operand_stack_top - 1] = *(int32_t*)(*(intptr_t*)&call_stack[operand_stack_top - 1] + sizeof(int32_t) * *(int32_t*)&call_stack[operand_stack_top]);
        operand_stack_top--;
        pc++;
        continue;
      case SPerl_BYTECODE_C_CODE_LALOAD:
        call_stack[operand_stack_top - 1] = *(int64_t*)(*(intptr_t*)&call_stack[operand_stack_top - 1] + sizeof(int64_t) * *(int32_t*)&call_stack[operand_stack_top]);
        operand_stack_top--;
        pc++;
        continue;
      case SPerl_BYTECODE_C_CODE_FALOAD:
        *(float*)&call_stack[operand_stack_top - 1] = *(float*)(*(intptr_t*)&call_stack[operand_stack_top - 1] + sizeof(float) * *(int32_t*)&call_stack[operand_stack_top]);
        operand_stack_top--;
        pc++;
        continue;
      case SPerl_BYTECODE_C_CODE_DALOAD:
        *(double*)&call_stack[operand_stack_top - 1] = *(double*)(*(intptr_t*)&call_stack[operand_stack_top - 1] + sizeof(double) * *(int32_t*)&call_stack[operand_stack_top]);
        operand_stack_top--;
        pc++;
        continue;
      case SPerl_BYTECODE_C_CODE_AALOAD:
        *(intptr_t*)&call_stack[operand_stack_top - 1] = *(intptr_t*)(*(intptr_t*)&call_stack[operand_stack_top - 1] + sizeof(intptr_t) * *(int32_t*)&call_stack[operand_stack_top]);
        operand_stack_top--;
        pc++;
        continue;
      case SPerl_BYTECODE_C_CODE_BALOAD:
        *(int32_t*)&call_stack[operand_stack_top - 1] = (int32_t)*(int8_t*)(*(intptr_t*)&call_stack[operand_stack_top - 1] + *(int32_t*)&call_stack[operand_stack_top]);
        operand_stack_top--;
        pc++;
        continue;
      case SPerl_BYTECODE_C_CODE_SALOAD:
        *(int32_t*)&call_stack[operand_stack_top - 1] = (int32_t)*(int16_t*)(*(intptr_t*)&call_stack[operand_stack_top - 1] + sizeof(int16_t) * *(int32_t*)&call_stack[operand_stack_top]);
        operand_stack_top--;
        pc++;
        continue;
      case SPerl_BYTECODE_C_CODE_IALOAD_L:
        *(int32_t*)&call_stack[operand_stack_top - 1] = *(int32_t*)(*(intptr_t*)&call_stack[operand_stack_top - 1] + sizeof(int32_t) * call_stack[operand_stack_top]);
        operand_stack_top--;
        pc++;
        continue;
      case SPerl_BYTECODE_C_CODE_LALOAD_L:
        call_stack[operand_stack_top - 1] = *(int64_t*)(*(intptr_t*)&call_stack[operand_stack_top - 1] + sizeof(int64_t) * call_stack[operand_stack_top]);
        operand_stack_top--;
        pc++;
        continue;
      case SPerl_BYTECODE_C_CODE_FALOAD_L:
        *(float*)&call_stack[operand_stack_top - 1] = *(float*)(*(intptr_t*)&call_stack[operand_stack_top - 1] + sizeof(float) * call_stack[operand_stack_top]);
        operand_stack_top--;
        pc++;
        continue;
      case SPerl_BYTECODE_C_CODE_DALOAD_L:
        *(double*)&call_stack[operand_stack_top - 1] = *(double*)(*(intptr_t*)&call_stack[operand_stack_top - 1] + sizeof(double) * call_stack[operand_stack_top]);
        operand_stack_top--;
        pc++;
        continue;
      case SPerl_BYTECODE_C_CODE_AALOAD_L:
        *(intptr_t*)&call_stack[operand_stack_top - 1] = *(intptr_t*)(*(intptr_t*)&call_stack[operand_stack_top - 1] + sizeof(intptr_t) * call_stack[operand_stack_top]);
        operand_stack_top--;
        pc++;
        continue;
      case SPerl_BYTECODE_C_CODE_BALOAD_L:
        *(int8_t*)&call_stack[operand_stack_top - 1] = (int32_t)*(int8_t*)(*(intptr_t*)&call_stack[operand_stack_top - 1] + call_stack[operand_stack_top]);
        operand_stack_top--;
        pc++;
        continue;
      case SPerl_BYTECODE_C_CODE_SALOAD_L:
        *(int16_t*)&call_stack[operand_stack_top - 1] = (int32_t)*(int16_t*)(*(intptr_t*)&call_stack[operand_stack_top - 1] + sizeof(int16_t) * call_stack[operand_stack_top]);
        operand_stack_top--;
        pc++;
        continue;
      ...
      case SPerl_BYTECODE_C_CODE_BASTORE:
        *(int8_t*)(*(intptr_t*)&call_stack[operand_stack_top - 2] + sizeof(int8_t) * *(int32_t*)&call_stack[operand_stack_top - 1])
          = (int8_t)*(int32_t*)&call_stack[operand_stack_top];
        operand_stack_top -= 3;
        pc++;
        continue;
      case SPerl_BYTECODE_C_CODE_SASTORE:
        *(int16_t*)(*(intptr_t*)&call_stack[operand_stack_top - 2] + sizeof(int16_t) * *(int32_t*)&call_stack[operand_stack_top - 1])
          = (int16_t)*(int32_t*)&call_stack[operand_stack_top];
        operand_stack_top -= 3;
        pc++;
        continue;
      case SPerl_BYTECODE_C_CODE_IASTORE:
        *(int32_t*)(*(intptr_t*)&call_stack[operand_stack_top - 2] + sizeof(int32_t) * *(int32_t*)&call_stack[operand_stack_top - 1])
          = *(int32_t*)&call_stack[operand_stack_top];
        operand_stack_top -= 3;
        pc++;
        continue;
      case SPerl_BYTECODE_C_CODE_LASTORE:
        *(int64_t*)(*(intptr_t*)&call_stack[operand_stack_top - 2] + sizeof(int64_t) * *(int32_t*)&call_stack[operand_stack_top - 1])
          = call_stack[operand_stack_top];
        operand_stack_top -= 3;
        pc++;
        continue;
      case SPerl_BYTECODE_C_CODE_FASTORE:
        *(float*)(*(intptr_t*)&call_stack[operand_stack_top - 2] + sizeof(float) * *(int32_t*)&call_stack[operand_stack_top - 1])
          = *(float*)&call_stack[operand_stack_top];
        operand_stack_top -= 3;
        pc++;
        continue;
      case SPerl_BYTECODE_C_CODE_DASTORE:
        *(double*)(*(intptr_t*)&call_stack[operand_stack_top - 2] + sizeof(double) * *(int32_t*)&call_stack[operand_stack_top - 1])
          = *(double*)&call_stack[operand_stack_top];
        operand_stack_top -= 3;
        pc++;
        continue;
      case SPerl_BYTECODE_C_CODE_AASTORE:
        *(intptr_t*)(*(intptr_t*)&call_stack[operand_stack_top - 2] + sizeof(intptr_t) * *(int32_t*)&call_stack[operand_stack_top - 1])
          = *(intptr_t*)&call_stack[operand_stack_top];
        operand_stack_top -= 3;
        pc++;
        continue;
      case SPerl_BYTECODE_C_CODE_BASTORE_L:
        *(int8_t*)(*(intptr_t*)&call_stack[operand_stack_top - 2] + sizeof(int8_t) * call_stack[operand_stack_top - 1])
          = (int8_t)*(int32_t*)&call_stack[operand_stack_top];
        operand_stack_top -= 3;
        pc++;
        continue;
      case SPerl_BYTECODE_C_CODE_SASTORE_L:
        *(int16_t*)(*(intptr_t*)&call_stack[operand_stack_top - 2] + sizeof(int16_t) * call_stack[operand_stack_top - 1])
          = (int16_t)*(int32_t*)&call_stack[operand_stack_top];
        operand_stack_top -= 3;
        pc++;
        continue;
      case SPerl_BYTECODE_C_CODE_IASTORE_L:
        *(int32_t*)(*(intptr_t*)&call_stack[operand_stack_top - 2] + sizeof(int32_t) * call_stack[operand_stack_top - 1])
          = *(int32_t*)&call_stack[operand_stack_top];
        operand_stack_top -= 3;
        pc++;
        continue;
      case SPerl_BYTECODE_C_CODE_LASTORE_L:
        *(int64_t*)(*(intptr_t*)&call_stack[operand_stack_top - 2] + sizeof(int64_t) * call_stack[operand_stack_top - 1])
          = call_stack[operand_stack_top];
        operand_stack_top -= 3;
        pc++;
        continue;
      case SPerl_BYTECODE_C_CODE_FASTORE_L:
        *(float*)(*(intptr_t*)&call_stack[operand_stack_top - 2] + sizeof(float) * call_stack[operand_stack_top - 1])
          = *(float*)&call_stack[operand_stack_top];
        operand_stack_top -= 3;
        pc++;
        continue;
      case SPerl_BYTECODE_C_CODE_DASTORE_L:
        *(double*)(*(intptr_t*)&call_stack[operand_stack_top - 2] + sizeof(double) * call_stack[operand_stack_top - 1])
          = *(double*)&call_stack[operand_stack_top];
        operand_stack_top -= 3;
        pc++;
        continue;
      case SPerl_BYTECODE_C_CODE_AASTORE_L:
        *(intptr_t*)(*(intptr_t*)&call_stack[operand_stack_top - 2] + sizeof(intptr_t) * call_stack[operand_stack_top - 1])
          = *(intptr_t*)&call_stack[operand_stack_top];
        operand_stack_top -= 3;
        pc++;
        continue;
