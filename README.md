...
## Run
    ...
    bison -p SPerl_yy -d sperly.y && gcc -O -o sperl sperly.tab.c sperl_main.c sperl_toke.c sperl_op.c sperl_array.c sperl_hash.c sperl_parser.c sperl_class_info.c sperl_global.c && ./sperl test.spl
