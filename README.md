...
## Run
    ...
    bison -p SPerl_yy -d sperly.y && gcc -O -o sperl sperly.tab.c sperl_main.c sperl_toke.c sperl_op.c sperl_collection.c sperl_parser.c sperl_class.c && ./sperl test.spl
