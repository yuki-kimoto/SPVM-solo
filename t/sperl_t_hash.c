...
int main()
{
  ...
  // Rehash
  {
    ...
    int32_t search_value1 = *(int32_t*)SPerl_HASH_search(sperl, hash, "key1", 4);
    OK(search_value1 == 1);
    int32_t search_value2 = *(int32_t*)SPerl_HASH_search(sperl, hash, "key2", 4);
    OK(search_value2 == 2);
    int32_t search_value3 = *(int32_t*)SPerl_HASH_search(sperl, hash, "key3", 4);
    OK(search_value3 == 3);
    int32_t search_value4 = *(int32_t*)SPerl_HASH_search(sperl, hash, "key4", 4);
    OK(search_value4 == 4);
    int32_t search_value5 = *(int32_t*)SPerl_HASH_search(sperl, hash, "key5", 4);
    OK(search_value5 == 5);
    ...
    int32_t search_value6 = *(int32_t*)SPerl_HASH_search(sperl, hash, "key6", 4);
    OK(search_value6 == 6);
    int32_t search_value7 = *(int32_t*)SPerl_HASH_search(sperl, hash, "key7", 4);
    OK(search_value7 == 7);
    int32_t search_value8 = *(int32_t*)SPerl_HASH_search(sperl, hash, "key8", 4);
    OK(search_value8 == 8);
    int32_t search_value9 = *(int32_t*)SPerl_HASH_search(sperl, hash, "key9", 4);
    OK(search_value9 == 9);
    int32_t search_value10 = *(int32_t*)SPerl_HASH_search(sperl, hash, "key10", 5);
