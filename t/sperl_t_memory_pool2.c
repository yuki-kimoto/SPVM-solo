...
int main()
{
  ...
  {
    SPerl_MEMORY_POOL2* memory_pool = SPerl_MEMORY_POOL2_new(sperl, sizeof(int64_t) * 2);
    
    int64_t* int_ptr1 = SPerl_MEMORY_POOL2_alloc(sperl, memory_pool, sizeof(int64_t));
    int64_t* int_ptr2 = SPerl_MEMORY_POOL2_alloc(sperl, memory_pool, sizeof(int64_t));
