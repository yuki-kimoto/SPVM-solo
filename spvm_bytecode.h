...
enum {
  ...
  SPVM_BYTECODE_C_CODE_MALLOC_ARRAY_NUMERIC,
  SPVM_BYTECODE_C_CODE_MALLOC_ARRAY_STRING,
  ...
  SPVM_BYTECODE_C_CODE_IF_EQ_ZERO_INT,
  SPVM_BYTECODE_C_CODE_IF_NE_ZERO_INT,
  SPVM_BYTECODE_C_CODE_IF_LT_ZERO_INT,
  SPVM_BYTECODE_C_CODE_IF_GE_ZERO_INT,
  SPVM_BYTECODE_C_CODE_IF_GT_ZERO_INT,
  SPVM_BYTECODE_C_CODE_IF_LE_ZERO_INT,
  SPVM_BYTECODE_C_CODE_IF_EQ_CMP_INT,
  SPVM_BYTECODE_C_CODE_IF_NE_CMP_INT,
  SPVM_BYTECODE_C_CODE_IF_LT_CMP_INT,
  SPVM_BYTECODE_C_CODE_IF_GE_CMP_INT,
  SPVM_BYTECODE_C_CODE_IF_GT_CMP_INT,
  SPVM_BYTECODE_C_CODE_IF_LE_CMP_INT,
  SPVM_BYTECODE_C_CODE_IF_NE_ZERO_LONG,
  SPVM_BYTECODE_C_CODE_IF_EQ_CMP_LONG,
  SPVM_BYTECODE_C_CODE_IF_NE_CMP_LONG,
  SPVM_BYTECODE_C_CODE_IF_LT_CMP_LONG,
  SPVM_BYTECODE_C_CODE_IF_GE_CMP_LONG,
  SPVM_BYTECODE_C_CODE_IF_GT_CMP_LONG,
  SPVM_BYTECODE_C_CODE_IF_LE_CMP_LONG,
  ...
  SPVM_BYTECODE_C_CODE_TABLE_SWITCH_INT,
  SPVM_BYTECODE_C_CODE_LOOKUP_SWITCH_INT,
  SPVM_BYTECODE_C_CODE_TABLE_SWITCH_LONG,
  SPVM_BYTECODE_C_CODE_LOOKUP_SWITCH_LONG,
