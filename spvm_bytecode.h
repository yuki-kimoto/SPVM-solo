...
enum {
  ...
  SPVM_BYTECODE_C_CODE_AND_BYTE,
  SPVM_BYTECODE_C_CODE_OR_BYTE ,
  SPVM_BYTECODE_C_CODE_XOR_BYTE,
  ...
  SPVM_BYTECODE_C_CODE_AND_SHORT,
  SPVM_BYTECODE_C_CODE_OR_SHORT ,
  SPVM_BYTECODE_C_CODE_XOR_SHORT,
