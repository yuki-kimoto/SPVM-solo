...
enum {
  ...
  SPVM_BYTECODE_C_CODE_IF_EQ_ZERO_LONG,
  SPVM_BYTECODE_C_CODE_IF_NE_ZERO_LONG,
  SPVM_BYTECODE_C_CODE_IF_LT_ZERO_LONG,
  SPVM_BYTECODE_C_CODE_IF_GE_ZERO_LONG,
  SPVM_BYTECODE_C_CODE_IF_GT_ZERO_LONG,
  SPVM_BYTECODE_C_CODE_IF_LE_ZERO_LONG,
