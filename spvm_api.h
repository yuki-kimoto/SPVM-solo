...
enum {
  ...
  // 16
  SPVM_API_C_OBJECT_HEADER_ARRAY_LENGTH_OR_SV_BYTE_OFFSET = SPVM_API_C_OBJECT_HEADER_REF_COUNT_BYTE_OFFSET + SPVM_API_C_OBJECT_HEADER_REF_COUNT_BYTE_SIZE,
  SPVM_API_C_OBJECT_HEADER_LENGTH_OR_ADDRESS_BYTE_SIZE = sizeof(intmax_t),
  
  SPVM_API_C_OBJECT_HEADER_BYTE_SIZE = SPVM_API_C_OBJECT_HEADER_ARRAY_LENGTH_OR_SV_BYTE_OFFSET + SPVM_API_C_OBJECT_HEADER_LENGTH_OR_ADDRESS_BYTE_SIZE,
};
