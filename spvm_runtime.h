...
void SPVM_RUNTIME_call_sub(SPVM* spvm, SPVM_ENV* env, const char* sub_base_name);

int32_t SPVM_RUNTIME_get_ref_count(SPVM* spvm, SPVM_ENV* env, SPVM_REF* ref);
...
void SPVM_RUNTIME_push_return_value_address(SPVM* spvm, SPVM_ENV* env, void* value);
