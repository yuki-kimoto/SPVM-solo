...
SPVM_RUNTIME* SPVM_RUNTIME_new(SPVM* spvm) {
  ...
  assert(sizeof(SPVM_DATA_ARRAY) <= SPVM_DATA_API_C_DATA_HEADER_BYTE_SIZE);
  assert(sizeof(SPVM_DATA_OBJECT) <= SPVM_DATA_API_C_DATA_HEADER_BYTE_SIZE);
  assert(sizeof(SPVM_DATA_STRING) <= SPVM_DATA_API_C_DATA_HEADER_BYTE_SIZE);
...
void SPVM_RUNTIME_call_sub(SPVM* spvm, SPVM_RUNTIME* runtime, int32_t sub_constant_pool_address) {
  ...
  SPVM_DATA_STRING* data_string_error;
  ...
  case_SPVM_BYTECODE_C_CODE_ARRAY_LOAD_BYTE:
    ...
    if (__builtin_expect(!data_array, 0)) {
      data_string_error = SPVM_RUNTIME_API_create_data_string_from_pv(spvm, runtime, "The array of byte to get the element must not be undef");
      operand_stack_top++;
      ...
      if (__builtin_expect(index < 0 || index >= data_array->length, 0)) {
        data_string_error = SPVM_RUNTIME_API_create_data_string_from_pv(spvm, runtime, "The index of the array of byte to get the element is out of range");
        operand_stack_top++;
        call_stack[operand_stack_top].address_value = data_string_error;
        goto case_SPVM_BYTECODE_C_CODE_DIE;
      }
        ...
        call_stack[operand_stack_top - 1].byte_value
          = *(int8_t*)((intptr_t)data_array + SPVM_DATA_API_C_DATA_HEADER_BYTE_SIZE + sizeof(int8_t) * index);
        operand_stack_top--;
        pc++;
        goto *jump[*pc];
      }
  ...
  case_SPVM_BYTECODE_C_CODE_ARRAY_LOAD_SHORT:
    ...
    index = call_stack[operand_stack_top].int_value;
    if (__builtin_expect(!data_array, 0)) {
      data_string_error = SPVM_RUNTIME_API_create_data_string_from_pv(spvm, runtime, "The array of short to get the element must not be undef");
      operand_stack_top++;
      call_stack[operand_stack_top].address_value = data_string_error;
      goto case_SPVM_BYTECODE_C_CODE_DIE;
    }
      ...
      if (__builtin_expect(index < 0 || index >= data_array->length, 0)) {
        data_string_error = SPVM_RUNTIME_API_create_data_string_from_pv(spvm, runtime, "The index of the array of short to get the element is out of range");
        operand_stack_top++;
        call_stack[operand_stack_top].address_value = data_string_error;
        goto case_SPVM_BYTECODE_C_CODE_DIE;
      }
        ...
        call_stack[operand_stack_top - 1].short_value
          = *(int16_t*)((intptr_t)data_array + SPVM_DATA_API_C_DATA_HEADER_BYTE_SIZE + sizeof(int16_t) * index);
        operand_stack_top--;
        pc++;
        goto *jump[*pc];
      }
  ...
  case_SPVM_BYTECODE_C_CODE_ARRAY_LOAD_INT:
    ...
    index = call_stack[operand_stack_top].int_value;
    if (__builtin_expect(!data_array, 0)) {
      data_string_error = SPVM_RUNTIME_API_create_data_string_from_pv(spvm, runtime, "The array of int to get the element must not be undef");
      operand_stack_top++;
      call_stack[operand_stack_top].address_value = data_string_error;
      goto case_SPVM_BYTECODE_C_CODE_DIE;
    }
      ...
      if (__builtin_expect(index < 0 || index >= data_array->length, 0)) {
        data_string_error = SPVM_RUNTIME_API_create_data_string_from_pv(spvm, runtime, "The index of the array of int to get the element is out of range");
        operand_stack_top++;
        call_stack[operand_stack_top].address_value = data_string_error;
        goto case_SPVM_BYTECODE_C_CODE_DIE;
      }
      else {
        call_stack[operand_stack_top - 1].int_value = *(int32_t*)((intptr_t)data_array + SPVM_DATA_API_C_DATA_HEADER_BYTE_SIZE + sizeof(int32_t) * index);
        operand_stack_top--;
        pc++;
        goto *jump[*pc];
      }
  ...
  case_SPVM_BYTECODE_C_CODE_ARRAY_LOAD_LONG:
    ...
    index = call_stack[operand_stack_top].int_value;
    if (__builtin_expect(!data_array, 0)) {
      data_string_error = SPVM_RUNTIME_API_create_data_string_from_pv(spvm, runtime, "The array of long to get the element must not be undef");
      operand_stack_top++;
      call_stack[operand_stack_top].address_value = data_string_error;
      goto case_SPVM_BYTECODE_C_CODE_DIE;
    }
      ...
      if (__builtin_expect(index < 0 || index >= data_array->length, 0)) {
        data_string_error = SPVM_RUNTIME_API_create_data_string_from_pv(spvm, runtime, "The index of the array of long to get the element is out of range");
        operand_stack_top++;
        call_stack[operand_stack_top].address_value = data_string_error;
        goto case_SPVM_BYTECODE_C_CODE_DIE;
      }
      else {
        call_stack[operand_stack_top - 1].long_value = *(int64_t*)((intptr_t)data_array + SPVM_DATA_API_C_DATA_HEADER_BYTE_SIZE + sizeof(int64_t) * index);
        operand_stack_top--;
        pc++;
        goto *jump[*pc];
      }
  ...
  case_SPVM_BYTECODE_C_CODE_ARRAY_LOAD_FLOAT:
    ...
    index = call_stack[operand_stack_top].int_value;
    if (__builtin_expect(!data_array, 0)) {
      data_string_error = SPVM_RUNTIME_API_create_data_string_from_pv(spvm, runtime, "The array of float to get the element must not be undef");
      operand_stack_top++;
      call_stack[operand_stack_top].address_value = data_string_error;
      goto case_SPVM_BYTECODE_C_CODE_DIE;
    }
      ...
      if (__builtin_expect(index < 0 || index >= data_array->length, 0)) {
        data_string_error = SPVM_RUNTIME_API_create_data_string_from_pv(spvm, runtime, "The index of the array of float to get the element is out of range");
        operand_stack_top++;
        call_stack[operand_stack_top].address_value = data_string_error;
        goto case_SPVM_BYTECODE_C_CODE_DIE;
      }
      else {
        call_stack[operand_stack_top - 1].float_value = *(float*)((intptr_t)data_array + SPVM_DATA_API_C_DATA_HEADER_BYTE_SIZE + sizeof(float) * index);
        operand_stack_top--;
        pc++;
        goto *jump[*pc];
      }
  ...
  case_SPVM_BYTECODE_C_CODE_ARRAY_LOAD_DOUBLE:
    ...
    index = call_stack[operand_stack_top].int_value;
    if (__builtin_expect(!data_array, 0)) {
      data_string_error = SPVM_RUNTIME_API_create_data_string_from_pv(spvm, runtime, "The array of double to get the element must not be undef");
      operand_stack_top++;
      call_stack[operand_stack_top].address_value = data_string_error;
      goto case_SPVM_BYTECODE_C_CODE_DIE;
    }
      ...
      if (__builtin_expect(index < 0 || index >= data_array->length, 0)) {
        data_string_error = SPVM_RUNTIME_API_create_data_string_from_pv(spvm, runtime, "The index of the array of double to get the element is out of range");
        operand_stack_top++;
        call_stack[operand_stack_top].address_value = data_string_error;
        goto case_SPVM_BYTECODE_C_CODE_DIE;
      }
      else {
        call_stack[operand_stack_top - 1].double_value = *(double*)((intptr_t)data_array + SPVM_DATA_API_C_DATA_HEADER_BYTE_SIZE + sizeof(double) * index);
        operand_stack_top--;
        pc++;
        goto *jump[*pc];
      }
  ...
  case_SPVM_BYTECODE_C_CODE_ARRAY_LOAD_ADDRESS:
    ...
    index = call_stack[operand_stack_top].int_value;
    if (__builtin_expect(!data_array, 0)) {
      data_string_error = SPVM_RUNTIME_API_create_data_string_from_pv(spvm, runtime, "The array of reference to get the element must not be undef");
      operand_stack_top++;
      call_stack[operand_stack_top].address_value = data_string_error;
      goto case_SPVM_BYTECODE_C_CODE_DIE;
    }
      ...
      if (__builtin_expect(index < 0 || index >= data_array->length, 0)) {
        data_string_error = SPVM_RUNTIME_API_create_data_string_from_pv(spvm, runtime, "The index of the array of reference to get the element is out of range");
        operand_stack_top++;
        call_stack[operand_stack_top].address_value = data_string_error;
        goto case_SPVM_BYTECODE_C_CODE_DIE;
      }
      else {
        call_stack[operand_stack_top - 1].address_value = *(void**)((intptr_t)data_array + SPVM_DATA_API_C_DATA_HEADER_BYTE_SIZE + sizeof(void*) * index);
        operand_stack_top--;
        pc++;
        goto *jump[*pc];
      }
  ...
  case_SPVM_BYTECODE_C_CODE_ARRAY_STORE_BYTE:
    ...
    if (__builtin_expect(!data_array, 0)) {
      data_string_error = SPVM_RUNTIME_API_create_data_string_from_pv(spvm, runtime, "The array of byte to set the element must not be undef");
      operand_stack_top++;
      call_stack[operand_stack_top].address_value = data_string_error;
      goto case_SPVM_BYTECODE_C_CODE_DIE;
    }
      ...
      if (__builtin_expect(index < 0 || index >= data_array->length, 0)) {
        data_string_error = SPVM_RUNTIME_API_create_data_string_from_pv(spvm, runtime, "The index of the array of byte to set the element is out of range");
        operand_stack_top++;
        call_stack[operand_stack_top].address_value = data_string_error;
        goto case_SPVM_BYTECODE_C_CODE_DIE;
      }
      else {
        *(int8_t*)((intptr_t)call_stack[operand_stack_top - 2].address_value + SPVM_DATA_API_C_DATA_HEADER_BYTE_SIZE + sizeof(int8_t) * call_stack[operand_stack_top - 1].int_value)
  ...
  case_SPVM_BYTECODE_C_CODE_ARRAY_STORE_SHORT:
    ...
    index = call_stack[operand_stack_top - 1].int_value;
    if (__builtin_expect(!data_array, 0)) {
      data_string_error = SPVM_RUNTIME_API_create_data_string_from_pv(spvm, runtime, "The array of short to set the element must not be undef");
      operand_stack_top++;
      call_stack[operand_stack_top].address_value = data_string_error;
      goto case_SPVM_BYTECODE_C_CODE_DIE;
    }
      ...
      if (__builtin_expect(index < 0 || index >= data_array->length, 0)) {
        data_string_error = SPVM_RUNTIME_API_create_data_string_from_pv(spvm, runtime, "The index of the array of short to set the element is out of range");
        operand_stack_top++;
        call_stack[operand_stack_top].address_value = data_string_error;
        goto case_SPVM_BYTECODE_C_CODE_DIE;
      }
      else {
        *(int16_t*)((intptr_t)call_stack[operand_stack_top - 2].address_value + SPVM_DATA_API_C_DATA_HEADER_BYTE_SIZE + sizeof(int16_t) * call_stack[operand_stack_top - 1].int_value)
  ...
  case_SPVM_BYTECODE_C_CODE_ARRAY_STORE_INT:
    ...
    index = call_stack[operand_stack_top - 1].int_value;
    if (__builtin_expect(!data_array, 0)) {
      data_string_error = SPVM_RUNTIME_API_create_data_string_from_pv(spvm, runtime, "The array of int to set the element must not be undef");
      operand_stack_top++;
      call_stack[operand_stack_top].address_value = data_string_error;
      goto case_SPVM_BYTECODE_C_CODE_DIE;
    }
      ...
      if (__builtin_expect(index < 0 || index >= data_array->length, 0)) {
        data_string_error = SPVM_RUNTIME_API_create_data_string_from_pv(spvm, runtime, "The index of the array of int to set the element is out of range");
        operand_stack_top++;
        call_stack[operand_stack_top].address_value = data_string_error;
        goto case_SPVM_BYTECODE_C_CODE_DIE;
      }
      else {
        *(int32_t*)((intptr_t)data_array + SPVM_DATA_API_C_DATA_HEADER_BYTE_SIZE + sizeof(int32_t) * index) = call_stack[operand_stack_top].int_value;
        operand_stack_top -= 3;
        pc++;
        goto *jump[*pc];
      }
  ...
  case_SPVM_BYTECODE_C_CODE_ARRAY_STORE_LONG:
    ...
    index = call_stack[operand_stack_top - 1].int_value;
    if (__builtin_expect(!data_array, 0)) {
      data_string_error = SPVM_RUNTIME_API_create_data_string_from_pv(spvm, runtime, "The array of long to set the element must not be undef");
      operand_stack_top++;
      call_stack[operand_stack_top].address_value = data_string_error;
      goto case_SPVM_BYTECODE_C_CODE_DIE;
    }
      ...
      if (__builtin_expect(index < 0 || index >= data_array->length, 0)) {
        ...
        *(int64_t*)((intptr_t)data_array + SPVM_DATA_API_C_DATA_HEADER_BYTE_SIZE + sizeof(int64_t) * index) = call_stack[operand_stack_top].long_value;
        operand_stack_top -= 3;
        pc++;
        goto *jump[*pc];
      }
  ...
  case_SPVM_BYTECODE_C_CODE_ARRAY_STORE_FLOAT:
    ...
    index = call_stack[operand_stack_top - 1].int_value;
    if (__builtin_expect(!data_array, 0)) {
      data_string_error = SPVM_RUNTIME_API_create_data_string_from_pv(spvm, runtime, "The array of float to set the element must not be undef");
      operand_stack_top++;
      call_stack[operand_stack_top].address_value = data_string_error;
      goto case_SPVM_BYTECODE_C_CODE_DIE;
    }
      ...
      if (__builtin_expect(index < 0 || index >= data_array->length, 0)) {
        data_string_error = SPVM_RUNTIME_API_create_data_string_from_pv(spvm, runtime, "The index of the array of float to set the element is out of range");
        operand_stack_top++;
        call_stack[operand_stack_top].address_value = data_string_error;
        goto case_SPVM_BYTECODE_C_CODE_DIE;
      }
      else {
        *(float*)((intptr_t)data_array + SPVM_DATA_API_C_DATA_HEADER_BYTE_SIZE + sizeof(float) * index) = call_stack[operand_stack_top - 1].float_value;
        operand_stack_top -= 3;
        pc++;
        goto *jump[*pc];
      }
  ...
  case_SPVM_BYTECODE_C_CODE_ARRAY_STORE_DOUBLE:
    ...
    index = call_stack[operand_stack_top - 1].int_value;
    if (__builtin_expect(!data_array, 0)) {
      data_string_error = SPVM_RUNTIME_API_create_data_string_from_pv(spvm, runtime, "The array of double to set the element must not be undef");
      operand_stack_top++;
      call_stack[operand_stack_top].address_value = data_string_error;
      goto case_SPVM_BYTECODE_C_CODE_DIE;
    }
      ...
      if (__builtin_expect(index < 0 || index >= data_array->length, 0)) {
        data_string_error = SPVM_RUNTIME_API_create_data_string_from_pv(spvm, runtime, "The index of the array of double to set the element is out of range");
        operand_stack_top++;
        call_stack[operand_stack_top].address_value = data_string_error;
        goto case_SPVM_BYTECODE_C_CODE_DIE;
      }
      else {
        *(double*)((intptr_t)call_stack[operand_stack_top - 2].address_value + SPVM_DATA_API_C_DATA_HEADER_BYTE_SIZE + sizeof(double) * call_stack[operand_stack_top - 1].int_value)
  ...
  case_SPVM_BYTECODE_C_CODE_ARRAY_STORE_ADDRESS: {
    ...
    index = call_stack[operand_stack_top - 1].int_value;
    if (__builtin_expect(!data_array, 0)) {
      data_string_error = SPVM_RUNTIME_API_create_data_string_from_pv(spvm, runtime, "The array of reference to set the element must not be undef");
      operand_stack_top++;
      call_stack[operand_stack_top].address_value = data_string_error;
      goto case_SPVM_BYTECODE_C_CODE_DIE;
    }
      ...
      if (__builtin_expect(index < 0 || index >= data_array->length, 0)) {
        data_string_error = SPVM_RUNTIME_API_create_data_string_from_pv(spvm, runtime, "The index of the array of reference to set the element is out of range");
        operand_stack_top++;
        call_stack[operand_stack_top].address_value = data_string_error;
        goto case_SPVM_BYTECODE_C_CODE_DIE;
      }
      else {
        SPVM_DATA** data_address = (SPVM_DATA**)((intptr_t)data_array + SPVM_DATA_API_C_DATA_HEADER_BYTE_SIZE + sizeof(void*) * index);
  ...
  case_SPVM_BYTECODE_C_CODE_MALLOC_OBJECT: {
    ...
    int32_t data_object_byte_size = SPVM_DATA_API_C_DATA_HEADER_BYTE_SIZE + sizeof(SPVM_VALUE) * fields_length;
    ...
    memset((void*)((intptr_t)data_object + SPVM_DATA_API_C_DATA_HEADER_BYTE_SIZE), 0, sizeof(void*) * constant_pool_package.ref_fields_length);
  ...
  case_SPVM_BYTECODE_C_CODE_MALLOC_STRING: {
    ...
    // Set string
    operand_stack_top++;
    call_stack[operand_stack_top].address_value = data_string;
  ...
  case_SPVM_BYTECODE_C_CODE_MALLOC_ARRAY: {
    ...
    // Allocate array
    int32_t data_array_byte_size = SPVM_DATA_API_C_DATA_HEADER_BYTE_SIZE + size * length;
    SPVM_DATA_ARRAY* data_array = SPVM_RUNTIME_ALLOCATOR_malloc(spvm, allocator, data_array_byte_size);
    
    // Memory allocation error
    if (!data_array) {
      // Error message
      SPVM_DATA_STRING* data_string_message = SPVM_RUNTIME_API_create_data_string_from_pv(spvm, runtime, "Failed to allocate memory(MALLOC_ARRAY)");
      
      // Error is converted to exception
      operand_stack_top++;
      call_stack[operand_stack_top].address_value = data_string_message;
      goto case_SPVM_BYTECODE_C_CODE_DIE;
    }
    
    // Init null if sub type is array of reference
    if (value_type == SPVM_DATA_ARRAY_C_VALUE_TYPE_REF) {
      memset((intptr_t)data_array + SPVM_DATA_API_C_DATA_HEADER_BYTE_SIZE, 0, size * length);
      SPVM_DATA* data_element = *(SPVM_DATA**)((intptr_t)data_array + SPVM_DATA_API_C_DATA_HEADER_BYTE_SIZE + sizeof(void*) * 0);
    }
  ...
  case_SPVM_BYTECODE_C_CODE_GET_FIELD_BYTE:
    ...
    if (__builtin_expect(!data_object, 0)) {
      ...
      index = (*(pc + 1) << 8) + *(pc + 2);
      call_stack[operand_stack_top].byte_value
        = *(int8_t*)((intptr_t)data_object + SPVM_DATA_API_C_DATA_HEADER_BYTE_SIZE + sizeof(SPVM_VALUE) * index);
      pc += 3;
      goto *jump[*pc];
    }
  case_SPVM_BYTECODE_C_CODE_GET_FIELD_SHORT:
    ...
    if (__builtin_expect(!data_object, 0)) {
      ...
      index = (*(pc + 1) << 8) + *(pc + 2);
      call_stack[operand_stack_top].short_value
        = *(int16_t*)((intptr_t)data_object + SPVM_DATA_API_C_DATA_HEADER_BYTE_SIZE + sizeof(SPVM_VALUE) * index);
      pc += 3;
      goto *jump[*pc];
    }
  case_SPVM_BYTECODE_C_CODE_GET_FIELD_INT:
    ...
    if (__builtin_expect(!data_object, 0)) {
      ...
      call_stack[operand_stack_top].int_value
        = *(int32_t*)((intptr_t)data_object + SPVM_DATA_API_C_DATA_HEADER_BYTE_SIZE + sizeof(SPVM_VALUE) * index);
      pc += 3;
      goto *jump[*pc];
    }
  case_SPVM_BYTECODE_C_CODE_GET_FIELD_LONG:
    ...
    if (__builtin_expect(!data_object, 0)) {
      ...
      call_stack[operand_stack_top].long_value
        = *(int64_t*)((intptr_t)data_object + SPVM_DATA_API_C_DATA_HEADER_BYTE_SIZE + sizeof(SPVM_VALUE) * index);
      pc += 3;
      goto *jump[*pc];
    }
  case_SPVM_BYTECODE_C_CODE_GET_FIELD_FLOAT:
    ...
    if (__builtin_expect(!data_object, 0)) {
      ...
      index = (*(pc + 1) << 8) + *(pc + 2);
      call_stack[operand_stack_top - 1].float_value
        = *(float*)((intptr_t)data_object + SPVM_DATA_API_C_DATA_HEADER_BYTE_SIZE + sizeof(SPVM_VALUE) * index);
      pc += 3;
      goto *jump[*pc];
    }
  case_SPVM_BYTECODE_C_CODE_GET_FIELD_DOUBLE:
    ...
    if (__builtin_expect(!data_object, 0)) {
      ...
      index = (*(pc + 1) << 8) + *(pc + 2);
      call_stack[operand_stack_top].double_value
        = *(double*)((intptr_t)data_object + SPVM_DATA_API_C_DATA_HEADER_BYTE_SIZE + sizeof(SPVM_VALUE) * index);
      pc += 3;
      goto *jump[*pc];
    }
  case_SPVM_BYTECODE_C_CODE_GET_FIELD_ADDRESS:
    ...
    if (__builtin_expect(!data_object, 0)) {
      ...
      call_stack[operand_stack_top].address_value
        = *(void**)((intptr_t)call_stack[operand_stack_top].address_value + SPVM_DATA_API_C_DATA_HEADER_BYTE_SIZE + sizeof(SPVM_VALUE) * index);
      pc += 3;
      goto *jump[*pc];
    }
  case_SPVM_BYTECODE_C_CODE_SET_FIELD_BYTE:
  ...
  case_SPVM_BYTECODE_C_CODE_SET_FIELD_ADDRESS: {
    data_object = (SPVM_DATA_OBJECT*)call_stack[operand_stack_top - 1].address_value;
    if (__builtin_expect(!data_object, 0)) {
      data_string_error = SPVM_RUNTIME_API_create_data_string_from_pv(spvm, runtime, "The object to set an reference field must not be undefined.");
      operand_stack_top++;
      call_stack[operand_stack_top].address_value = data_string_error;
      goto case_SPVM_BYTECODE_C_CODE_DIE;
    }
