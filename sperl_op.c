...
SPerl_OP* SPerl_OP_newOP_PACKAGE(SPerl_PARSER* parser, SPerl_OP* op_pkgname, SPerl_OP* op_block, SPerl_OP* op_descripters) {
  ...
  SPerl_char* name = (SPerl_char*)op_pkgname->ptr_value;
  ...
  if (found_class_info) {
    ...
    while (op_cur) {
      ...
      if (op_cur->type == SPerl_OP_HAS) {
        SPerl_FIELD_INFO* field_info = (SPerl_FIELD_INFO*)op_cur->ptr_value;
      ...
      // Method
        ...
        SPerl_METHOD_INFO* method_info = (SPerl_METHOD_INFO*)op_cur->ptr_value;
        ...
        SPerl_USE_INFO* use_info = (SPerl_USE_INFO*)op_cur->ptr_value;
...
SPerl_OP* SPerl_OP_newOP_USE(SPerl_PARSER* parser, SPerl_OP* op_pkgname, SPerl_OP* op_pkgalias) {
  ...
  use_info->class_name = (SPerl_char*)op_pkgname->ptr_value;
  if (op_pkgalias) {
    use_info->alias_name = (SPerl_char*)op_pkgalias->ptr_value;
  }
  op->ptr_value = use_info;
...
SPerl_OP* SPerl_OP_newOP_MY(SPerl_PARSER* parser, SPerl_OP* op_var, SPerl_OP* op_desctype) {
  ...
  SPerl_VAR_INFO* var_info = (SPerl_VAR_INFO*)op_var->ptr_value;
  my_var_info->name = var_info->name;
  
  // type
  my_var_info->type = (SPerl_char*)op_desctype->first->ptr_value;
...
SPerl_OP* SPerl_OP_newOP_HAS(SPerl_PARSER* parser, SPerl_OP* op_field_name, SPerl_OP* op_desctype) {
  ...
  field_info->name = (SPerl_char*)op_field_name->ptr_value;
  
  // type
  field_info->type = (SPerl_char*)op_desctype->first->ptr_value;
  
  // descripters
  SPerl_OP* op_descripters = op_desctype->last;
  field_info->desc_flags |= SPerl_OP_create_desc_flags(parser, op_descripters);
  
  op->ptr_value = field_info;
...
SPerl_OP* SPerl_OP_newOP_CONST(SPerl_PARSER* parser, SPerl_OP* op) {
  ...
  SPerl_CONST_INFO* const_info = (SPerl_CONST_INFO*)op->ptr_value;
...
SPerl_char SPerl_OP_create_desc_flags(SPerl_PARSER* parser, SPerl_OP* op_descripters) {
  ...
  if (op_descripters->type == SPerl_OP_LIST) {
    ...
    while (op_next = SPerl_OP_sibling(parser, op_next)) {
      desc_flags |= SPerl_DESCRIPTER_get_flag((SPerl_char*)op_next->ptr_value);
    }
  }
  // descripters is descripter
  else if (op_descripters->type == SPerl_OP_CONST) {
    desc_flags |= SPerl_DESCRIPTER_get_flag((SPerl_char*)op_descripters->ptr_value);
  }
...
SPerl_OP* SPerl_OP_newOP_SUB(SPerl_PARSER* parser, SPerl_OP* op_subname, SPerl_OP* op_optsubargs, SPerl_OP* op_desctype, SPerl_OP* op_block) {
  ...
  method_info->name = (SPerl_char*)op_subname->ptr_value;
  ...
  // return type
  method_info->return_type = (SPerl_char*)op_desctype->first->ptr_value;
  ...
  while (op_cur) {
    ...
    if (op_cur->type == SPerl_OP_MY) {
      SPerl_MY_VAR_INFO* my_var_info = (SPerl_MY_VAR_INFO*)op_cur->ptr_value;
