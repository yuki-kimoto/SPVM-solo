...
SPerl_OP* SPerl_OP_build_wordtype(SPerl_PARSER* parser, SPerl_OP* op_wordtype) {
  ...
  // Type component word
  SPerl_TYPE_COMPONENT_WORD* type_component_word = SPerl_TYPE_COMPONENT_WORD_new(parser);
  type_component_word->op_name = op_wordtype;
  ...
  SPerl_OP* op_type_word = SPerl_OP_newOP(parser, SPerl_OP_C_CODE_TYPE, op_wordtype, NULL);
  op_type_word->uv.type = type;
  op_type_word->file = op_wordtype->file;
  op_type_word->line = op_wordtype->line;
