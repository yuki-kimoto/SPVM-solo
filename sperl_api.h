...
enum {
  ...
  // 1
  SPerl_API_C_OBJECT_HEADER_PADDING1_BYTE_OFFSET = SPerl_API_C_OBJECT_HEADER_TYPE_BYTE_OFFSET + SPerl_API_C_OBJECT_HEADER_TYPE_BYTE_SIZE,
  SPerl_API_C_OBJECT_HEADER_PADDING1_BYTE_SIZE = sizeof(int8_t),

  // 2
  SPerl_API_C_OBJECT_HEADER_FREELIST_INDEX_BYTE_OFFSET = SPerl_API_C_OBJECT_HEADER_PADDING1_BYTE_OFFSET + SPerl_API_C_OBJECT_HEADER_PADDING1_BYTE_SIZE,
