...
SPerl_OP* SPerl_OP_build_call_field(SPerl* sperl, SPerl_OP* op_packagename, SPerl_OP* op_fieldname);
...
SPerl_OP* SPerl_OP_build_field(SPerl* sperl, SPerl_OP* op_has, SPerl_OP* op_field_base_name, SPerl_OP* type);
