...
enum {
  ...
  SPerl_API_C_OBJECT_HEADER_BYTE_SIZE_BYTE_OFFSET = SPerl_API_C_OBJECT_HEADER_PADDING2_BYTE_OFFSET + SPerl_API_C_OBJECT_HEADER_PADDING2_BYTE_SIZE,
  SPerl_API_C_OBJECT_HEADER_BYTE_SIZE_BYTE_SIZE = sizeof(int16_t),
  
  SPerl_API_C_OBJECT_HEADER_PADDING5_BYTE_OFFSET = SPerl_API_C_OBJECT_HEADER_BYTE_SIZE_BYTE_OFFSET + SPerl_API_C_OBJECT_HEADER_BYTE_SIZE_BYTE_SIZE,
  ...
  SPerl_API_C_OBJECT_HEADER_PADDING7_BYTE_OFFSET = SPerl_API_C_OBJECT_HEADER_PADDING6_BYTE_OFFSET + SPerl_API_C_OBJECT_HEADER_PADDING6_BYTE_SIZE,
  SPerl_API_C_OBJECT_HEADER_PADDING7_BYTE_SIZE = sizeof(int8_t),
  
  SPerl_API_C_OBJECT_HEADER_REF_COUNT_BYTE_OFFSET = SPerl_API_C_OBJECT_HEADER_PADDING7_BYTE_OFFSET + SPerl_API_C_OBJECT_HEADER_PADDING7_BYTE_SIZE,
