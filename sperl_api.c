...
enum {
  ...
  SPerl_API_C_OBJECT_HEADER_PADDING1_BYTE_OFFSET = SPerl_API_C_OBJECT_HEADER_FREELIST_INDEX_BYTE_OFFSET + SPerl_API_C_OBJECT_HEADER_FREELIST_INDEX_BYTE_SIZE,
  SPerl_API_C_OBJECT_HEADER_PADDING1_BYTE_SIZE = sizeof(int8_t),
  SPerl_API_C_OBJECT_HEADER_PADDING2_BYTE_OFFSET = SPerl_API_C_OBJECT_HEADER_PADDING1_BYTE_OFFSET + SPerl_API_C_OBJECT_HEADER_PADDING1_BYTE_SIZE,
  ...
  SPerl_API_C_OBJECT_HEADER_PADDING4_BYTE_OFFSET = SPerl_API_C_OBJECT_HEADER_PADDING3_BYTE_OFFSET + SPerl_API_C_OBJECT_HEADER_PADDING3_BYTE_SIZE,
  SPerl_API_C_OBJECT_HEADER_PADDING4_BYTE_SIZE = sizeof(int8_t),
  SPerl_API_C_OBJECT_HEADER_PADDING5_BYTE_OFFSET = SPerl_API_C_OBJECT_HEADER_PADDING4_BYTE_OFFSET + SPerl_API_C_OBJECT_HEADER_PADDING4_BYTE_SIZE,
  SPerl_API_C_OBJECT_HEADER_PADDING5_BYTE_SIZE = sizeof(int8_t),
  SPerl_API_C_OBJECT_HEADER_PADDING6_BYTE_OFFSET = SPerl_API_C_OBJECT_HEADER_PADDING5_BYTE_OFFSET + SPerl_API_C_OBJECT_HEADER_PADDING5_BYTE_SIZE,
  SPerl_API_C_OBJECT_HEADER_PADDING6_BYTE_SIZE = sizeof(int8_t),
  
  SPerl_API_C_OBJECT_HEADER_REF_COUNT_BYTE_OFFSET = SPerl_API_C_OBJECT_HEADER_PADDING6_BYTE_OFFSET + SPerl_API_C_OBJECT_HEADER_PADDING6_BYTE_SIZE,
...
int64_t SPerl_API_get_array_length(SPerl* sperl, SPerl_ENV* env, void* array) {
  ...
  return *(int64_t*)(array + SPerl_API_C_OBJECT_HEADER_LENGTH_OR_ADDRESS_BYTE_OFFSET);
}
...
int64_t SPerl_API_get_array_ref_count(SPerl* sperl, SPerl_ENV* env, void* array) {
  ...
  return *(int64_t*)(array + SPerl_API_C_OBJECT_HEADER_REF_COUNT_BYTE_OFFSET);
}
...
int8_t* SPerl_API_get_byte_array_data(SPerl* sperl, SPerl_ENV* env, void* array) {
  ...
  return (int8_t*)(array +  SPerl_API_C_OBJECT_HEADER_BYTE_SIZE);
}
...
int16_t* SPerl_API_get_short_array_data(SPerl* sperl, SPerl_ENV* env, void* array) {
  ...
  return (int16_t*)(array +  SPerl_API_C_OBJECT_HEADER_BYTE_SIZE);
}
...
int32_t* SPerl_API_get_int_array_data(SPerl* sperl, SPerl_ENV* env, void* array) {
  ...
  return (int32_t*)(array +  SPerl_API_C_OBJECT_HEADER_BYTE_SIZE);
}
...
int64_t* SPerl_API_get_long_array_data(SPerl* sperl, SPerl_ENV* env, void* array) {
  ...
  return (int64_t*)(array +  SPerl_API_C_OBJECT_HEADER_BYTE_SIZE);
}
...
float* SPerl_API_get_float_array_data(SPerl* sperl, SPerl_ENV* env, void* array) {
  ...
  return (float*)(array +  SPerl_API_C_OBJECT_HEADER_BYTE_SIZE);
}
...
double* SPerl_API_get_double_array_data(SPerl* sperl, SPerl_ENV* env, void* array) {
  ...
  return (double*)(array + SPerl_API_C_OBJECT_HEADER_BYTE_SIZE);
}
